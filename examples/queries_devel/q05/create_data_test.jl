...
function example_dataset(wcs_user_sk, wcs_item_sk, item_sk, i_category_id, i_category, c_customer_sk, c_current_cdemo_sk, cd_demo_sk, cd_gender, cd_education_status)
    append!(wcs_user_sk, [1,1,2,1,2,3])
    append!(wcs_item_sk, [1,1,2,1,2,3])
    append!(item_sk, [1,1,2,1,2,3])
...
function generate_dataset(wcs_user_sk, wcs_item_sk, item_sk, i_category_id, i_category, c_customer_sk, c_current_cdemo_sk, cd_demo_sk, cd_gender, cd_education_status, table_wcs_path, table_i_path, table_c_path, table_cd_path)
...
function main()
    ...
    if option == 0
        example_dataset(wcs_user_sk, wcs_item_sk, item_sk, i_category_id, i_category, c_customer_sk, c_current_cdemo_sk, cd_demo_sk, cd_gender, cd_education_status)
    end

    if option == 1
        generate_dataset(wcs_user_sk, wcs_item_sk, item_sk, i_category_id, i_category, c_customer_sk, c_current_cdemo_sk, cd_demo_sk, cd_gender, cd_education_status)
    end
    ...
    h5write(file_name ,"/item_sk", item_sk)
